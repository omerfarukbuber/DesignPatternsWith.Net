...
public class ProductRepositoryWithPostgresql(ApplicationDbContextPostgresql context) : IProductRepository
{
    private readonly ApplicationDbContextPostgresql _context = context;
